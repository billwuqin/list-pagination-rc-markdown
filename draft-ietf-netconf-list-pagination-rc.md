...
##  Query Parameters
   ...
   3.1 and 3.2 in {{!I-D.ietf-netconf-list-pagination}}. Note that complex
   pagination with combination of query parameters may cause performance
   strain on constrained devices due to intensive processing on both the
